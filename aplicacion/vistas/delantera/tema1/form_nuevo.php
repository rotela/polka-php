<div class="row">
  ...
  <div class="col-md-8">
    ...
    ?>
    <form class="form-horizontal" role="form" action="<?= base_url('usuarios/nuevo'); ?>" method="post">

      <div class="form-group <?= $estado_nombre; ?>">
        <label class="col-lg-4 control-label" for="nombre">Nombre</label>
        <div class="col-lg-8">
          <input type="text" class="form-control" name="nombre" id="nombre" value="<?= obt_valor('nombre'); ?>" placeholder="nombre">
        </div>
      </div>
      <div class="form-group <?= $estado_edad; ?>">
        <label class="col-lg-4 control-label" for="edad">Edad</label>
        <div class="col-lg-8">
          <input type="text" class="form-control" name="edad" id="edad" value="<?= obt_valor('edad'); ?>" placeholder="edad">
        </div>
      </div>
      <div class="form-group <?= $estado_profesion; ?>">
        <label class="col-lg-4 control-label" for="profesion">Profesión</label>
        <div class="col-lg-8">
          <input type="text" class="form-control" name="profesion" id="profesion" value="<?= obt_valor('profesion'); ?>" placeholder="profesion">
        </div>
      </div>
