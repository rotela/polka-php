...
?>
<form class="form-horizontal" role="form" action="<?= base_url('articulos/nuevo'); ?>" method="post">
  <div class="form-group">
    <label class="col-lg-3 control-label" for="idsec">Sección</label>
    <div class="col-lg-9">
    <?= agr_selector('idsec',$secciones,'idsec','','class="form-control"'); ?>
    </div>
  </div>
  <div class="form-group <?= $e_titulo; ?>">
    <label class="col-lg-3 control-label" for="titulo">Título</label>
    <div class="col-lg-9">
      <input type="text" class="form-control" name="titulo" id="titulo" value="<?= obt_valor('titulo'); ?>" placeholder="Título">
    </div>
  </div>
  <div class="form-group <?= $e_titulo_url; ?>">
    <label class="col-lg-3 control-label" for="titulo_url">Url</label>
    <div class="col-lg-9">
      <input type="text" class="form-control" name="titulo_url" id="titulo_url" value="<?= obt_valor('titulo_url'); ?>" placeholder="Url">
    </div>
  </div>
  ...
  <div class="form-group <?= $e_contenido; ?>">
    ...
    <div class="col-lg-9">
      <textarea class="ckeditor" name="contenido" id="contenido"><?= obt_valor('contenido'); ?></textarea>
    </div>
  </div>
  ...
  <div class="form-group <?= $e_tags; ?>">
    ...
    <div class="col-lg-9">
      <input type="text" class="form-control" name="tags" id="tags" value="<?= obt_valor('tags'); ?>" placeholder="Tags">
    </div>
  </div>
